...
const navItems = [
  ...
  { label: 'Organisations', href: '/admin/coming-soon?section=Organisations', icon: Building2, section: 'USERS & ORGS' },
  { label: 'Teams', href: '/admin/coming-soon?section=Teams', icon: Briefcase, section: 'USERS & ORGS' },
  { label: 'Coaches & Certs', href: '/admin/coming-soon?section=Coaches', icon: GraduationCap, section: 'USERS & ORGS' },
  { label: 'Share Grants', href: '/admin/coming-soon?section=Share+Grants', icon: LinkIcon, section: 'SHARING & ACCESS' },
  { label: 'Audit Logs', href: '/admin/coming-soon?section=Audit+Logs', icon: ClipboardList, section: 'SHARING & ACCESS' },
  { label: 'Purchases', href: '/admin/coming-soon?section=Purchases', icon: CreditCard, section: 'BILLING' },
  { label: 'Referral Codes', href: '/admin/coming-soon?section=Referral+Codes', icon: Tag, section: 'BILLING' },
  { label: 'Partner Orgs', href: '/admin/coming-soon?section=Partner+Orgs', icon: Handshake, section: 'BILLING' },
