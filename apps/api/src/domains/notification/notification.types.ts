...
export interface INotificationService {
  ...
  sendSms(userId: string, message: string, channel?: string): Promise<void>;
...
export type NotificationEvent = (
  ...
  | { type: 'share_granted'; userId?: string; subjectUserId?: string; targetUserId?: string; resourceTypes?: string[]; subjectName?: string }
